...
<div class="row">
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo01" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo02" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo03" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo04" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo05" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo06" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo07" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo08" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo09" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo15" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo16" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo17" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo18" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo19" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo20" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo21" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo22" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo23" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo24" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo25" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo26" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo27" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo28" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo29" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="exercices/exo30" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="tpArmes/tpArmes01" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="tpArmes/tpArmes02" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="tpArmes/tpArmes03" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="tpArmes/tpArmes04" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="tpArmes/tpArmes05" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="tpArmes/tpArmes06" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col s12 m6 l4">
        <div class="card medium teal darken-2">
            ...
            <div class="card-action">
                <a href="tpArmes/tpArmes07" class="valign-wrapper">exercice <i class="material-icons">arrow_forward</i></a>
            </div>
        </div>
    </div>
